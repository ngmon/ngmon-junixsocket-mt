...
final class NativeUnixSocket {
    ...
    native static void getUserCredentials(final FileDescriptor fd,
            final UserCredentials userCredentials)
            throws IOException;

    native static void setPassUserCredentials(final FileDescriptor fd,
            final boolean passUserCredentials)
            throws IOException;
