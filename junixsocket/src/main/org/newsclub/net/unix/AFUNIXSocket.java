...
public class AFUNIXSocket extends Socket {
    ...
    /**
     * Returns the {@link UserCredentials} of the peer, if available.
     * 
     * The {@link AFUNIXServerSocket#setPassUserCredentials(boolean)} method
     * may need to be called prior to conneciton acceptance with a value of true
     * to get the credentials to be available.
     *  
